...
//
// This package implements an old versin of the bookmarks spec that contains
// serious race conditions that may result in the loss of some bookmarks.
// As such it should only be used for adding backwards compatibility with legacy
// clients and servers that do not use the same storage backend for bookmarks
